...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-purple-800 to-blue-700 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            ...
            <nav className="hidden md:block ml-10">
              <div className="flex items-baseline space-x-4">
                <Link
                  href="/"
                  className="text-white hover:bg-blue-600 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
                >
                  Início
                </Link>
                <Link
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <span className="text-gray-300 text-xs hidden lg:inline-block">
              por Kevin Lopes
            </span>
          </div>
